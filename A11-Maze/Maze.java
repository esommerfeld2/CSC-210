...
public class Maze implements DisplayableMaze{
  ...
  /**
     * Maze constructor empty
     */
    public Maze(){
      this.mazeGrid = new MazeContents[0][0];
    }  
  ...
  /**
     ...
     * @param i height
     * @param j width
     * @param si start height
     * @param sj start width
     * @param fi finish height
     * @param fj finish width
     */
    public Maze(int i, int j, int si, int sj, int fi, int fj){
      this.height = i;
      this.width = j;
      this.mazeGrid = new MazeContents[height][width];
      this.start = new MazeLocation(si,sj);
      this.finish = new MazeLocation(fi,fj);
    }
     ...
     * @param finish finish
     */
    public Maze(int i, int j, MazeLocation start, MazeLocation finish){
      this.height = i;
      this.width = j;
      this.mazeGrid = new MazeContents[height][width];
      this.start = start;
    ...
    /** Gets the contents of the maze grid at row i, column j
     * @param i row
     * @param j column
    ...
    /** GSts the contents of the maze grid at row i, column j
     * @param i row
     * @param j column
    */
    public void setContents(int i, int j, MazeContents content){
      this.mazeGrid[i][j] = content;
    }

    /** Gets whether the maze grid is explorable at row i, column j
     * @param i row
     * @param j column
     *  @return True or False to indicate whether the maze grid is explorable at row i, column j */
    ...
    /**Returns location of maze finish point
