...
YES 1 pts: Program throws appropriate exceptions (with informative error messages)
...
NO Iterator can get elements

NO Iterator can set elements

NO Iterator can add elements

NO Iterator can remove elements
